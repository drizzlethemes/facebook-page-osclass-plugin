...
<div class="footer">
    <p class="form-row">
    &copy; <?php echo date('Y'); ?> Facebook Page Plugin - <a href="http://forums.osclass.org/plugins/facebook-page-plugin/" target="_blank"><?php _e('Support', 'fb_page_plugin'); ?></a> - <a href="http://www.drizzlethemes.com/">DrizzleThemes</a>.
    </p>
</div>